...
public interface Manager {
     ...
     * 批量增加对象信息
     * 
     * @param InvoiceProductInfoList
     * @return
     */
    public boolean insert(List<InvoiceProductInfo> InvoiceProductInfoList);
     ...
     * 
     * @param InvoiceProductInfos
     *            InvoiceProductInfo集合
     * @return
     */
    public boolean delete(InvoiceProductInfo[] invoiceProductInfos);
