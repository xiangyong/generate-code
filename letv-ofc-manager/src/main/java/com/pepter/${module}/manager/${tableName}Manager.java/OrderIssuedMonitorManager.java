...
public interface Manager {
     ...
     * 批量增加对象信息
     * 
     * @param OrderIssuedMonitorList
     * @return
     */
    public boolean insert(List<OrderIssuedMonitor> OrderIssuedMonitorList);
     ...
     * 
     * @param OrderIssuedMonitors
     *            OrderIssuedMonitor集合
     * @return
     */
    public boolean delete(OrderIssuedMonitor[] orderIssuedMonitors);
