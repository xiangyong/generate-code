...
public interface Manager {
     ...
     * 批量增加对象信息
     * 
     * @param OrderStatisticsMonitorList
     * @return
     */
    public boolean insert(List<OrderStatisticsMonitor> OrderStatisticsMonitorList);
     ...
     * 
     * @param OrderStatisticsMonitors
     *            OrderStatisticsMonitor集合
     * @return
     */
    public boolean delete(OrderStatisticsMonitor[] orderStatisticsMonitors);
